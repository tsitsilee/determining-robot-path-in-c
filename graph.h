/* 
  ...
  contains some definitions of the queue edgenode and graph
  contains all the signatures of the functions used in graphImplementation.cpp
  
  for implemnetation of these functions please check the graphImplementation.cpp file
